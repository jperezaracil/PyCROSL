...
class SubstrateInt(Substrate):
    ...
    def evolve(self, solution, strength, population, objfunc):
        ...
        if self.evolution_method == "1point":
            ...
            result = DERand1(solution.solution, others, 2, 0.8)
        elif self.evolution_method == "DE/rand/2":
            result = DEBest2(solution.solution, others, 2, 0.8)
        elif self.evolution_method == "DE/best/2":
            result = DERand2(solution.solution, others, 2, 0.8)
        elif self.evolution_method == "DE/current-to-rand/1":
            result = DECurrentToBest1(solution.solution, others, 2, 0.8)
...
def blxalpha(solution1, solution2, alpha=0.7):
    return alp*solution1 + (1-alpha)*solution2
